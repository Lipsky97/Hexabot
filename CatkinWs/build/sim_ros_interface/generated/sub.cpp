    ...
    else if(in->topicType == "project_demo/Leg")
    {
        subscriberProxy->subscriber = nh->subscribe<project_demo::Leg>(in->topicName, in->queueSize, boost::bind(ros_callback__project_demo__Leg, _1, subscriberProxy));
    }
