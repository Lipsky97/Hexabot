...
void write__project_demo__Leg(const project_demo::Leg& msg, int stack, const WriteOptions *opt = NULL);
void read__project_demo__Leg(int stack, project_demo::Leg *msg, const ReadOptions *opt = NULL);
